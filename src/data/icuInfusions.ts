...
export const icuInfusionGroups: InfusionGroup[] = [
  {
    ...
    infusions: [
      ...
      },
      {
        ...
        maxDose: 2,
        perKg: true,
        notes: "Pure α₁ agonist — useful when tachycardia limits other agents, and in vasoplegia after cardiac surgery. Common theatre dilution is 10 mg in 100 mL = 100 micrograms/mL. Usual range 0.1–2 micrograms/kg/min (≈7–140 micrograms/min at 70 kg); higher rates occasionally used in refractory vasoplegia. May drop cardiac output by reflex bradycardia and afterload rise.",
        topicIds: ["vasoactive-agents"],
      },
      {
        drug: "Dopamine",
